      ...
      try {
        ...
        switch (msg.type) {
          ...
          case "response.created":
            // If agent is still speaking, this response was triggered by loopback — cancel it
            if (agentSpeaking && openaiWs?.readyState === WebSocket.OPEN) {
              console.log("🚫 Cancelling loopback response");
          ...
          case "response.audio.done": {
            ...
            // Small fixed delay to let last audio packet reach Telnyx before opening mic
            setTimeout(() => {

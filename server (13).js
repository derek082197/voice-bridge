      ...
      try {
        ...
        switch (msg.type) {
          ...
          case "response.audio.done":
            // Small delay before opening mic to avoid echo of last audio chunk
            setTimeout(() => { agentSpeaking = false; }, 300);
            if (streamSid && telnyxWs.readyState === WebSocket.OPEN) {
          ...
          case "response.done":
            // Safety net — ensure mic always opens after response completes
            setTimeout(() => { agentSpeaking = false; }, 300);
            break;
